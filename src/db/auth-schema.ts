// Better Auth's tables (accounts, sessions, API keys, the MCP OAuth provider).
// Generated by `npx auth@1.7.6 generate` from src/auth/auth.ts — regenerate
// rather than hand-edit when a Better Auth plugin changes.
